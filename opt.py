...
def config_parser(cmd=None):
    ...
    parser.add_argument("--basedir", type=str, default='/home/haochen/data_new/mvsnerf/log',
                        help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='/home/haochen/data_new/scans_512',
                        help='input data directory')
    #mvsnerf/render_sample75_512
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['dtu', 'blender', 'llff', 'dtu_ft', 'portrait'])
